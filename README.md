...
To train random box grid: uv run train Mjlab-HLIP-CLF-Random-Box-Grid-Unitree-G1 --env.scene.num-envs 4096
...
To play random box grid: uv run play Mjlab-HLIP-CLF-Random-Box-Grid-Unitree-G1
